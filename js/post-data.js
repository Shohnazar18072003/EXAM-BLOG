const posts= [
   ...
   },
   {
     ...
     "description": "Dive into the depths and discover the bizarre and fascinating creatures that call the ocean floor home.",
   ...
   },
   {
     ...
     "description": "Embark on a culinary adventure through Thailand's vibrant streets and indulge in the unique flavors of its delicious cuisine.",
   ...
   },
   {
     ...
     "description": "Hit the slopes and experience the breathtaking scenery and exhilarating adventures of skiing in the majestic Alps.",
   ...
   },
   {
     ...
     "description": "Find inner peace and reduce stress through the practice of mindfulness, learning simple techniques to focus on the present moment.",
   ...
   },
   {
     ...
     "description": "Take your first steps into the world of coding and learn the basics of building a website with simple, beginner-friendly instructions.",
     "author": "Tech Guru",
     "date": "2023-12-14",
   ...
   },
   {
     ...
     "description": "Learn to identify constellations, planets, and other celestial objects, and discover the awe-inspiring beauty of the universe.",
   ...
   },
   {
     ...
     "description": "Make small changes in your daily life to reduce your environmental impact and contribute to a more sustainable future.",
   ...
   },
   {
     ...
     "description": "Learn the secrets of effective storytelling, from crafting compelling narratives to engaging your audience and leaving a lasting impression.",
